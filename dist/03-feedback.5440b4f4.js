...
function onFormInput(event) {
    const formData1 = form.elements;
    const email = formData1.email.value;
    const message = formData1.message.value;
    const dataToSave = {
        email,
        message
    };
...
function onFormSubmit(event) {
    ...
    if (email.value === "" || message.value === "") return window.alert("\u0423\u0441\u0456 \u043F\u043E\u043B\u044F \u043F\u043E\u0432\u0438\u043D\u043D\u0456 \u0431\u0443\u0442\u0438 \u0437\u0430\u043F\u043E\u0432\u043D\u0435\u043D\u0456!");
